      ...
      <div className="container_inner rounded-[20px] overflow-hidden">
        ...
        <div className="relative lg:min-h-[900px] min-h-[700px] rounded-[20px] overflow-hidden">
          ...
          <div className="relative xl:pt-[231px] pt-[150px] xl:pl-[295px] pl-10 max-w-[914px]">
            ...
            <Link
              href="#"
              className="arrow_btn max-w-[222px]"
            >
          ...
          <div className="absolute bottom-0 left-0 right-0 -mt-10 bg-white/10 backdrop-blur rounded-b-[20px] py-6 px-6">
            ...
            <div
              className="flex items-center lg:gap-[122px] gap-10 overflow-x-auto scrollbar-hide lg:overflow-visible lg:justify-center"
            >
              <Image src={dean} alt="dean" className="min-w-[99px] h-[75px] object-contain" />
              <Image src={kerala} alt="kerala" className="min-w-[99px] h-[75px] object-contain" />
              <Image src={nitech} alt="nitech" className="min-w-[99px] h-[75px] object-contain" />
              <Image src={root} alt="root" className="min-w-[99px] h-[75px] object-contain" />
              <Image src={pad} alt="pad" className="min-w-[99px] h-[75px] object-contain" />
            </div>
        ...
        <section className="relative bg-white overflow-hidden mt-6 lg:mt-0">
          ...
          <div className="relative max-w-[1340px] mx-auto grid lg:grid-cols-6 lg:gap-y-24 gap-y-6 place-items-center ">
            ...
            <div className="service_circle col-span-2">
              <Image src={service1} alt="Legal service" width={80} height={80} />
              <p className="service_circle_title">Legal service</p>
            </div>

            {/* Top Center */}
            <div className="service_circle col-span-2">
              <Image src={service2} alt="Manufacturing service" width={80} height={80} />
              <p className="service_circle_title">Manufacturing service</p>
            </div>

            {/* Top Right */}
            <div className="service_circle col-span-2">
              <Image src={service3} alt="Administrative service" width={80} height={80} />
            ...
            {/* Bottom Left */}
            <div className="service_circle col-span-2">
              <Image src={service4} alt="Human Resource" width={80} height={80} />
              <p className="service_circle_title">Human Resource</p>
            </div>

            {/* Bottom Right */}
            <div className="service_circle col-span-2">
              <Image src={service5} alt="Construction service" width={80} height={80} />
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div className="space-y-8">
                <div className="">
                  <span className="about_us_badge uppercase">WHY WORK WITH ME</span>
                  <h2 className="service_section_title">
              ...
              <div className="space-y-6 flex flex-col items-end">
                ...
                <div className="why_card bg-[#1E552A]">
                  ...
                  <div>
                    <h3 className="why_card_title text-white">Continuous GDP Growth</h3>
                    <p className="text-white">Ranked 39th worldwide with 8.2% GDP rate in 2019, Bangladesh has made a major advancement in the economic sector.</p>
                  </div>
                </div>
                {/* Card 2 */}
                <div className="why_card bg-white max-w-[512px]">
                  ...
                  <div>
                    <h3 className="why_card_title text-[#1E552A]">Strategic Location</h3>
                    <p className="text-[#2D2D2D]">The location of Bangladesh in South Asia makes it very convenient for any successful industrial venture.</p>
                  </div>
                </div>
                {/* Card 3 */}
                <div className="why_card bg-white">
                  ...
                  <div>
                    <h3 className="why_card_title text-[#1E552A]">Cost-efficient Human Resource</h3>
                    <p className="text-[#2D2D2D]">Compared to the manpower of other industrially enriched countries, managing Bangladesh&apos;s workforce is much more cost-effective.</p>
                  </div>
                </div>
                {/* Card 4 */}
                <div className="why_card bg-white max-w-[512px]">
                  ...
                  <div>
                    <h3 className="why_card_title text-[#1E552A]">Energetic Manpower</h3>
                    <p className="text-[#2D2D2D]">Bangladesh has produced a vast number of skilled workforce in recent years who are prepared for diversified industrial activities.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container_main_div md:pt-18.75 pt-5 md:pb-26.25 pb-5 px-4 2xl:px-0">
          <div className="service_section_header">
            <div>
              ...
              <h2 className="service_section_title">
                Latest News & <br /> <span className="font-light">Insights</span>
              </h2>
              {/* Description */}
              <p className="about_us_description mt-3 pb-6">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl">
              ...
              <h4 className="news_card_title">SEZL Signs Landmark Deal with Global Textile Manufacturer</h4>
            ...
            <div className="bg-white p-6 rounded-2xl">
              <Image
                ...
                className="news_card_img" />
              <span className="news_card_header">ECONOMY</span>
              <h4 className="news_card_title">The Future of Sustainable
                Industrialization in Bangladesh</h4>
              <p className="news_card_date">Oct 26, 2023</p>
            </div>
            {/* card 3 */}
            <div className="bg-white p-6 rounded-2xl">
