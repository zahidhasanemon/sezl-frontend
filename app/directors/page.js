    ...
    <div className="bg-[#F8F8F8]">
      ...
      <div>
        ...
        <div className="common_hero_section mb-0">
          <h2 className="common_hero_heading">Board of Directors</h2>
        </div>
        ...
        <div className="leadership_section">
          <div className="leadership_contents">
            ...
            <div>
                ...
                <p className="text-[#2D2D2D]">Our board is united by a commitment to fostering robust industrial development through sustainable practices, ethical governance, and a steadfast focus on creating long-term value and confidence for our investors.</p>
            </div>
          </div>
        </div>
      </div>
